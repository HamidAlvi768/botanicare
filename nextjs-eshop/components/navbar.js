            ...
            <div className="uk-navbar-right uk-text-bold">
                    ...
                    <ul className="uk-list">
                      ...
                      <li>
                        ...
                        <div uk-dropdown="mode: click">
                          <ul className="uk-list">
                            <li>
                              <Link href="#"><a href="#">Category 1</a></Link>
                            </li>
                            <li>
                              <Link href="#"><a href="#">Category 2</a></Link>
                            </li>
                          </ul>
                        </div>
                      </li>
                      ...
                      <li>
                        <Link href="/cart"><a><i className="las la-shopping-cart la-2x"></i>CART</a></Link>
                      </li>
                    </ul>
                  </div>
                </div>
              ...
              <ul className="uk-navbar-nav uk-visible@m">
                ...
                <li>
                  ...
                  <div uk-dropdown="mode: click">
                    <ul className="uk-list">
                      <Link href="#"><a>Category 1</a></Link>
                      <Link href="#"><a>Category 2</a></Link>
                    </ul>
                  </div>
                </li>
                <li>
